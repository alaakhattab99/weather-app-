...
const apiKey= '300d8940d5dc93efe72255df248f3e35'; 

//Button Event listener 'click' 
button.addEventListener('click', function(){
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${input.value}&units=metric&appid=300d8940d5dc93efe72255df248f3e35`)
...
const iconSrc= `http://openweathermap.org/img/wn/02d@2x.png`;
    ...
    window.wind.innerHTML= speed ;
    window.humidity.innerHTML= humidity;
    window.pressure.innerHTML= pressure;
    window.icon.src= `http://openweathermap.org/img/wn/02d@2x.png`;  
